...
public class Server2 {
    ...
    public static void main(String args[]) throws IOException, ClassNotFoundException {
        ...
        while (true) {
            ...
            System.out.println("Operacion recibida en Server2: " + operacion);
        ...
        System.out.println("Cerrando Server2");
